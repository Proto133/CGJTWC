      ...
      <q-toolbar class="q-px-md">
        ...
        <q-toolbar-title class="text-h6 text-weight-bold">
          <router-link to="/" class="brand-link">
            <!-- Files in public/ are served from the web root, so the path is
                 absolute (/assets/...), not relative to this component.
                 The -white variant is the mono knockout mark, for dark surfaces
                 like this navy header. Use JTWC-navy-* on light backgrounds.
                 Both are generated by design/build_logo.py. -->
            <img
              src="/assets/JTWC-white-192.png"
              alt="Trojans Wrestling Club logo"
              class="brand-logo"
            />
            <span>Trojans Wrestling Club</span>
          </router-link>
        </q-toolbar-title>
